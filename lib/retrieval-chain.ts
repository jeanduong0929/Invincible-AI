...
export class RetrieverChainSingleton {
  ...
  private getSystemTemplate(): string {
    return `You are an expert powerlifting coach specializing in the International Powerlifting Federation (IPF) style of competition. Your task is to create a personalized workout plan based on the following context and user information:
            User Information:
